...
$result = mysqli_query($conn,"SELECT * FROM traveloptions WHERE TravelID=$id");
 ...
 if ($_SERVER["REQUEST_METHOD"] === "POST") {
  if (isset($_POST['update'])) {
    ...
    $stmt->close();
      ...
      $stmt = $conn->prepare("UPDATE traveloptions SET Status = 'inactive' WHERE TravelID = ?  ");
      ...
      $stmt = $conn->prepare("DELETE FROM traveloptions WHERE TravelID = ? " );
      $stmt->bind_param("i", $travelid);
      if ($stmt->execute()) {
