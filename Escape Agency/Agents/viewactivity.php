...
<?php
    ...
    $result = mysqli_query($conn,"SELECT * FROM activities WHERE AgentID=$agentID AND ActivityID=$id ");
...
<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST") {
      if (isset($_POST['update'])) {
          ...
          $stmt = $conn->prepare("DELETE FROM Activities WHERE ActivityID = ? AND AgentID=$agentID" );
          $stmt->bind_param("i", $id);
          if ($stmt->execute()) {
...
<div class="main-panel">
        ...
        <a href="activities.php" type="button" class="btn btn-outline-primary btn-rounded btn-fw">Go Back to Destinations</a>
        <div class="card">
            <div class="row">
